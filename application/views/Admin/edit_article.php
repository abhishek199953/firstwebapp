...
<h1>Edit Articles</h1>
 ...
 <?php echo form_open_multipart("admin/updatearticle/{$article->id} ");   // this line is used  for getting id of article ?>
<!--<?php echo form_hidden('article_id',$article->id); ?> -->
 ...
 <div class="col-lg-6">
  ...
  <?php // //,'value'=>set_value('image_path',$article->image_path)]) ; ?>
